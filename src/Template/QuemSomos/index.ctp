<div class="row">
  <div class="col-sm-6 quem-somos-content" >
	<h1 class="title-section"><i class="fa fontawesome-icon fa-university circle-no" style="font-size:26px;margin-right:13px;"></i>Quem Somos</h1>	
  ...
  <div class="col-sm-6 bg">
  	...
  	<div class="row quem-somos-imgs">
  		...
  		<div class="col-sm-6">
  			<?= $this->Html->image("quem-somos-2.png"); ?>
  		</div>
