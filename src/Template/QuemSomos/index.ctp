<div class="row">
  <div class="col-lg-6 quem-somos-content" >
    ...
    <p>
    <b>2RA ADVOCACIA</b> tem sua conduta baseada na Ética, tanto no relacionamento com o cliente quanto com os demais integrantes da relação jurídica, atuando de forma estratégica na estruturação de teses jurídicas e na avaliação dos riscos, em sintonia com os anseios da sociedade e do mundo globalizado.
    </p>	
